...
<head>
	<meta charset="utf-8">
    <meta http-equiv="refresh" content="3; url=<%=request.getContextPath()%>/front/seller/login.jsp">
...
<body>
	...
	<div id="success">
		...
		<h3>
			<p>3秒後自動回到廠商登入頁面</p>
			<p><a href="<%=request.getContextPath()%>/front/seller/login.jsp"><button>立即回到廠商登入頁面</button></a></p>
		</h3>
	</div>
